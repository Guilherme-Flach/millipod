...
#define FAZENDEIRO_SPEED 5
#define FAZEDEIRO_STARTING_LIVES 3

#define MILIPEDE_SEGMENT_SCORE 250
#define MILIPEDE_HEAD_SCORE 300
#define MILIPEDE_BORDER_COLLIDE_X 30
#define KILL_ZONE 50
#define OFF_SCREEN_XY -100
#define MILIPEDE_STARTING_Y -30
